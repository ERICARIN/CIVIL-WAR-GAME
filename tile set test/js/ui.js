function updateDossierUI() {
    ...
    const colorEl = document.getElementById('dossier-color').querySelector('span');

    if (nameEl) nameEl.textContent = player.name;
    if (factionEl) factionEl.textContent = `Фракция: ${player.factionInfo.name} ${player.factionInfo.icon}`;
